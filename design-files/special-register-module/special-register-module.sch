...
U 1 1 61BD63C2
P 7250 2150
F 0 "U402" H 7500 2950 50  0000 C CNN
F 1 "74HCT377" H 7500 2850 50  0000 C CNN
F 2 "Package_DIP:DIP-20_W7.62mm_Socket" H 7250 2150 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74LS377" H 7250 2150 50  0001 C CNN
	1    7250 2150
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 61BD884C
P 9400 2000
F 0 "U405" V 9650 1300 50  0000 R CNN
F 1 "74HCT245" V 9550 1350 50  0000 R CNN
F 2 "Package_DIP:DIP-20_W7.62mm_Socket" H 9400 2000 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74LS245" H 9400 2000 50  0001 C CNN
	1    9400 2000
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
U 1 1 61BDD6A6
P 9800 2500
F 0 "#PWR0103" H 9800 2350 50  0001 C CNN
F 1 "VCC" H 9815 2673 50  0000 C CNN
F 2 "" H 9800 2500 50  0001 C CNN
F 3 "" H 9800 2500 50  0001 C CNN
	1    9800 2500
	-1   0    0    1   
$EndComp
Text GLabel 8900 1500 1    50   Output ~ 0
BUS_D0
Text GLabel 9000 1500 1    50   Output ~ 0
BUS_D1
Text GLabel 9100 1500 1    50   Output ~ 0
BUS_D2
Text GLabel 9200 1500 1    50   Output ~ 0
BUS_D3
Text GLabel 9300 1500 1    50   Output ~ 0
BUS_D4
Text GLabel 9400 1500 1    50   Output ~ 0
BUS_D5
Text GLabel 9500 1500 1    50   Output ~ 0
BUS_D6
Text GLabel 9600 1500 1    50   Output ~ 0
BUS_D7
$Comp
L 74xx:74LS245 U408
U 1 1 61BE426D
...
~ucSR
Text Notes 6250 1550 0    50   Italic 10
Stack Pointer
Text Notes 11650 1550 0    50   Italic 10
Immediate Value
Text GLabel 8900 2900 3    50   Output ~ 0
sp_0
Text GLabel 9000 2900 3    50   Output ~ 0
sp_1
Text GLabel 9100 2900 3    50   Output ~ 0
sp_2
Text GLabel 9200 2900 3    50   Output ~ 0
sp_3
Text GLabel 9300 2900 3    50   Output ~ 0
sp_4
Text GLabel 9400 2900 3    50   Output ~ 0
sp_5
Text GLabel 9500 2900 3    50   Output ~ 0
sp_6
Text GLabel 9600 2900 3    50   Output ~ 0
sp_7
Wire Wire Line
	9600 2900 9600 2850
...
U 1 1 61D13B27
P 6850 1150
F 0 "C402" H 6942 1196 50  0000 L CNN
F 1 "0.1µF" H 6942 1105 50  0000 L CNN
F 2 "Capacitor_THT:C_Radial_D6.3mm_H5.0mm_P2.50mm" H 6850 1150 50  0001 C CNN
F 3 "~" H 6850 1150 50  0001 C CNN
F 4 "80-C320C104K2R5TA" H 6850 1150 50  0001 C CNN "Mouser"
	1    6850 1150
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 61D152AF
P 6850 1250
F 0 "#PWR0137" H 6850 1000 50  0001 C CNN
...
U 1 1 61D2334A
P 7250 1050
F 0 "#PWR0138" H 7250 900 50  0001 C CNN
...
U 1 1 61D6F6C2
P 8450 2150
F 0 "C405" H 8542 2196 50  0000 L CNN
F 1 "0.1µF" H 8542 2105 50  0000 L CNN
F 2 "Capacitor_THT:C_Radial_D6.3mm_H5.0mm_P2.50mm" H 8450 2150 50  0001 C CNN
F 3 "~" H 8450 2150 50  0001 C CNN
F 4 "80-C320C104K2R5TA" H 8450 2150 50  0001 C CNN "Mouser"
	1    8450 2150
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 61D70570
P 8450 2250
F 0 "#PWR0147" H 8450 2000 50  0001 C CNN
...
U 1 1 61D78A34
P 8450 2000
F 0 "#PWR0148" H 8450 1850 50  0001 C CNN
F 1 "VCC" H 8465 2173 50  0000 C CNN
